...
var f = class {
  ...
  _parseResults(t) {
    var _a;
    return (_a = t.results || []) == null ? void 0 : _a.map((e) => {
...
var b = class {
  constructor(t) {
    ...
    if (n.Util.setOptions(this, t), t == null ? void 0 : t.apiKey) throw Error("apiKey is not supported, use app_id/app_code instead!");
  }
  geocode(t) {
    const e = l(this.options, {
      searchtext: t,
  ...
  async getJSON(t, e) {
    var _a, _b2;
    return (((_b2 = (_a = (await c(t, e)).response.view) == null ? void 0 : _a[0]) == null ? void 0 : _b2.result) || []).map((o) => {
...
function q(i) {
  return (i == null ? void 0 : i.apiKey) ? new y(i) : new b(i);
}
function x(i) {
  let t;
...
var R = class {
  ...
  _parseResults(t) {
    var _a;
    return ((_a = t.features) == null ? void 0 : _a.length) ? t.features.map((e) => {
...
var E = class {
  ...
  _parseResults(t) {
    var _a, _b;
    return (((_b = (_a = t.results) == null ? void 0 : _a[0]) == null ? void 0 : _b.locations) || []).map((s) => {
...
var u = class {
  ...
  async reverse(t, e) {
    ...
    if (!(o == null ? void 0 : o.lat) || !(o == null ? void 0 : o.lon))
      return [];
...
var P = class {
  ...
  async geocode(t, e) {
    var _a, _b, _c, _d;
    const s = l(this.options, { q: t }), o = (_b = (_a = e == null ? void 0 : e.map) == null ? void 0 : _a.getCenter) == null ? void 0 : _b.call(_a);
    o && (s.lat = o.lat, s.lon = o.lng);
    const r = (_d = (_c = e == null ? void 0 : e.map) == null ? void 0 : _c.getZoom) == null ? void 0 : _d.call(_c);
    r && (s.zoom = r);
  ...
  _parseResults(t) {
    return (t.features || []).map((e) => {
      var _a;
      const s = e.geometry.coordinates, o = new n.LatLng(s[1], s[0]), r = (_a = e.properties) == null ? void 0 : _a.extent, a = r ? new n.LatLngBounds([r[1], r[0]], [r[3], r[2]]) : new n.LatLngBounds(o, o);
      return {
  ...
  _decodeFeatureName(t) {
    return (this.options.nameProperties || []).map((e) => {
      var _a;
      return (_a = t.properties) == null ? void 0 : _a[e];
    }).filter((e) => !!e).join(", ");
  }
};
function ot(i) {
...
var L = class extends m {
  ...
  constructor(t) {
    ...
    __publicField(this, "_alts");
    __publicField(this, "_container");
    __publicField(this, "_errorElement");
    __publicField(this, "_geocodeMarker");
    __publicField(this, "_input");
    __publicField(this, "_lastGeocode");
    __publicField(this, "_map");
    __publicField(this, "_preventBlurCollapse");
    __publicField(this, "_requestCount", 0);
    __publicField(this, "_results");
    __publicField(this, "_selection");
    __publicField(this, "_suggestTimeout");
    n.Util.setOptions(this, t), this.options.geocoder || (this.options.geocoder = new u());
  }
  addThrobberClass() {
  ...
  onAdd(t) {
    ...
    return a.type = "search", a.value = this.options.query, a.placeholder = this.options.placeholder, n.DomEvent.disableClickPropagation(a), this._errorElement = n.DomUtil.create("div", e + "-form-no-error", s), this._errorElement.innerHTML = this.options.errorMessage, this._alts = n.DomUtil.create(
      ...
      s
    ), n.DomEvent.disableClickPropagation(this._alts), n.DomEvent.on(a, "keydown", this._keydown, this), ((_a = this.options.geocoder) == null ? void 0 : _a.suggest) && n.DomEvent.on(a, "input", this._change, this), n.DomEvent.on(a, "blur", () => {
  ...
  _createAlt(t, e) {
    const s = n.DomUtil.create("li", ""), o = n.DomUtil.create("a", "", s), r = this.options.showResultIcons && t.icon ? n.DomUtil.create("img", "", o) : null, a = t.html ? void 0 : document.createTextNode(t.name), d = (B) => {
      this._preventBlurCollapse = true, n.DomEvent.stop(B), this._geocodeResultSelected(t), n.DomEvent.on(s, "click touchend", () => {

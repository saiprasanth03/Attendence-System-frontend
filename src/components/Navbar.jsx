...
//   return (
//     <div className="w-full bg-white shadow-sm border-b px-8 py-4 flex justify-between items-center rounded-[10px]">
...
//         {/* Dropdown */}
//         {open && (
//           <div className="absolute right-0 mt-3 w-48 bg-white shadow-xl rounded-lg border overflow-hidden animate-fadeIn">
